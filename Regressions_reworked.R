...
#PLOT 1) PERFORMANCE/METACOG ~ DEMOGRPAHICS 
...
setwd("/Users/dream/Documents/Fleming Stuff/")
...
HDDM = read.csv('subjParams_2k_3chain.csv') # load HDDM data
...
mRatio<-matrix(0,length(taskData$analyseddata),1)
...
#join HDDM variables to exisiting dataframe
...
# test magnitudes of contrasts for mean confid model? Not sure what this is
...
factorRegFig$Type[factorRegFig$Type=="AD"]<-"Anxious-zung"
